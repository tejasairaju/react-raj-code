...
const CreateBespokeDisclosures = (props) => {
  ...
  const getframeworkDetails = async (id = '') => {
    try {
      ...
      setFrameworkdetails({
        ...frameDetails,
        frameLogo: frameDetails['logo'],
        frameDec: frameDetails['description'],
        frameName: frameDetails['name'],
        supported_sectors: [{ name: frameDetails['supported_sectors'][0], id: '', isSelect: true }],
    ...
    <>
      ...
      <>
        <table className='default-flex-table create-disc-framework-details'>
          <tr>
            <td>{FrameData && <img src={FrameData.logo} alt={FrameData.name} width={'28px'} height={'28px'} />}</td>
      ...
      <div className='main__content-wrapper'>
        ...
        <div className='create-framework__row-wrapper create__disclosure_ref ref__no'>
          ...
          <div className='create__disclosure_container'>
            ...
            <Input
              ...
              className='create-framework__input create-disclosure-input'
              placeholder=''
              required={true}
        ...
        <div className='create__disclosure_container'>
          <h1 className='create-framework__title'>
            Guidance<span className='color-red P-4'>*</span>
          </h1>
