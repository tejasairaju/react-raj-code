...
const ManageCountry = (props) => {
  ...
  const headers = ['Country', 'Status', 'Action'];

  return (
    <>
      <div className='main__top-wrapper'>
        <h1 className='main__title custom-title'>{'Manage Masters -> Country'}</h1>
      </div>
      ...
      />
      {error && (
        <div className='category-error color-red'>* Country field may not be blank or contains invalid char or should be between 3 and 30 character or already Exists.</div>
      )}
      <br />
