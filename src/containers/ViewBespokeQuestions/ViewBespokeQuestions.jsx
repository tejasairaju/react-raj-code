  ...
  return (
    <>
      ...
      <div id='viewQuestions' className='view-questions-container'>
        ...
        <CreateBespokeQuestions title='View/Edit Bespoke Questions' isTemplate={true} createQuestions={false} questionList={inputList} onUpdateQuestions={onUpdateQuestions} />
      </div>
