        ...
        if (!_isEmpty(inputValue.from && inputValue.to)) {
          ...
          try {
            ...
            const response = await axios
              .put(`${process.env.API_BASE_URL}/organizations/${clientDetails.name}`, form, {
    ...
    <>
      ...
      <div className='main__content-wrapper'>
        ...
        <Input
          ...
          readOnly={true}
          placeholder='ESG Disclose'
          required={true}
          onChangeHandler={onChangeHandler}
        />
        <Input
          inputblockcls={`user_input_block ${_get(validation, 'location', false) ? 'user_input_error' : null}`}
        ...
        />
        <Input
          inputblockcls={`user_input_block ${_get(validation, 'headquarters', false) ? 'user_input_error' : null}`}
          error={validation['hq']}
          label={'Headquarters'}
          type='text'
          name='headquarters'
          value={inputValue.headquarters}
          className='create-framework__input'
          readOnly={isView}
          placeholder='London'
          required={true}
        ...
        <h1 className='create-framework__title'>No of users</h1>
        <div className='create-framework__row-wrapper dates'>
          ...
          <label htmlFor='create-framework__date-from' className='create-framework__label'>
            <input
              ...
              min='2000-01-01'
              max='2100-01-01'
              id='create-framework__date-from'
              required=''
              onChange={onChangeHandler}
              readOnly={isView}
            />
