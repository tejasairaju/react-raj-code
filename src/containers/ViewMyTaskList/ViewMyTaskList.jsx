...
const ViewMyTaskList = (props) => {
    ...
    return (<>
            ...
            <div class="main__top-wrapper view-task-list-contianer">
                <h1 class={`main__title ${getColor(status)} custom-title`}>
                ...
                <tbody>
                        {(reportList || []).map((report, index) => {
                            ...
                            return (<tr key={index}>
                                ...
                                <td><a onClick={() => redirectToViewDisclosures(report)} className={`answer-redirect-link cursor-pointer`}>View Disclosures</a></td>
                            </tr>);
                            // }
                        })}
                    </tbody>
