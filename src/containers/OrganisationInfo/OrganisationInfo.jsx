...
const OrganisationInfo = () => {
  ...
  const getOrganisation = async (id = '') => {
    try {
      ...
      const constractInputVal = {
        ...inputValue,
        ...orgInfo,
        employees_count: orgInfo.employees_count,
    ...
    if (
      ...
      try {
        ...
        const response = await axios
          .put(`${process.env.API_BASE_URL}/organizations/${orgDetails.name}`, form, {
    ...
    return (
      <>
          ...
          <div className='framework__row-wrapper bot1'>
            <div className='framework__row'>
              <div className='framework__col-wrapper'>
                <div className='framework__row bot1'>
                  <Label label={'Head Quarters'} required={true} />
                ...
                <div className='framework__row'>
                  ...
                  <Dropdown
                    className_1={'framework__input'}
                    className_2={''}
                    options={empCount}
                    name='employees_count'
                    value={(inputValue && inputValue.employees_count) || ''}
            ...
            <div className='framework__row'>
              ...
              <TextAreaBox
                label=''
                name='address'
                value={inputValue && inputValue.address}
          ...
          <div className='framework__row-wrapper bot1'>
            <div className='framework__row'>
              ...
              <ReactMultiSelectDropdown
                ...
                selectedOptionVal={inputValue && inputValue.sectors}
            ...
            <div className='framework__row'>
              ...
              <ReactMultiSelectDropdown
                ...
                isEditable={isEditable}
                selectedOptionVal={inputValue && inputValue.subsectors}
        ...
        <div className='flex save-orgi-btn'>
          <button onClick={() => onSaveHandler()} className='main__button'>
            SAVE
          </button>
        </div>
      </>
  ...
  const renderTitle = () => (
    <div className='main__top-wrapper'>
      <h1 className='main__title custom-title'>Organisational Information</h1>
    </div>
  );
